  ...
  if (contactInput) {
    contactInput.addEventListener('input', function () {
      ...
      if (value.length === 11 && /^0\d{10}$/.test(value)) {
        ...
        this.setCustomValidity('Please enter a valid 11-digit phone number starting with 0 (e.g., 09123456789)');
...
function validateStep(step) {
  ...
  switch (step) {
    ...
    case 5:
      ...
      // Validate phone number format (11-digit Philippine number starting with 0)
      ...
      if (!/^0\d{10}$/.test(phone)) {
        ...
        // showValidationAlert('Invalid Input', 'Please enter a valid 11-digit phone number starting with 0 (e.g., 09123456789)');
        // return false;
      }
      if (!petNameValue) {
